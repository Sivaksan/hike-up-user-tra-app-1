...
const StartconnectionScreen = ({ navigation }) => {
    return (
    ...
    function beginconnectionButton() {
        return (
            <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => { navigation.push('Endconnection') }}
...
export default StartconnectionScreen
