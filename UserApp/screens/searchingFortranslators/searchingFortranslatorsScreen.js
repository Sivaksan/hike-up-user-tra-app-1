...
const SearchingFortranslatorsScreen = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.whiteColor }}>
            ...
            {searchingtranslatorSheet()}
        </SafeAreaView>
    )

    function searchingtranslatorSheet() {
        return (
            <Animatable.View
                animation="slideInUp"
                iterationCount={1}
            ...
            >
                ...
                {searchingInfo()}
                {progressInfo()}
                {cancelconnectionAndContinueButton()}
            </Animatable.View>
        )
    }
    ...
    function cancelconnectionAndContinueButton() {
        return (
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => { navigation.push('translatorDetail') }}
    ...
    function searchingInfo() {
        return (
            <View style={{ alignItems: 'center', marginTop: Sizes.fixPadding + 5.0 }}>
                <Image
                    source={require('../../assets/images/searchtranslator.png')}
...
export default SearchingFortranslatorsScreen
