...
const translatorDetailScreen = ({ navigation }) => {
    ...
    function moreAndCancelconnectionButton() {
        return (
            <View style={styles.moreAndCancelconnectionButtonWrapStyle}>
                <TouchableOpacity
                    activeOpacity={0.8}
                ...
                <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => { navigation.push('connectionStarted') }}
                    style={styles.cancelconnectionButtonStyle}
                >
    ...
    function translatorInfo() {
        return (
            <View>
                {translatorImageWithCallAndMessage()}
                {translatorDetail()}
            </View>
        )
    }

    function translatorDetail() {
        return (
    ...
    function translatorImageWithCallAndMessage() {
        return (
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => { navigation.push('ChatWithtranslator') }}
...
export default translatorDetailScreen
...
const styles = StyleSheet.create({
    ...
    moreAndCancelconnectionButtonWrapStyle: {
        flexDirection: 'row',
        alignItems: 'center',
