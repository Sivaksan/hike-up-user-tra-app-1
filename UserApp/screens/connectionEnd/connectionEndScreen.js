...
const connectionEndScreen = ({ navigation }) => {
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.shadowColor }}>
            ...
            <View style={{ flex: 1 }}>
                {directionInfo()}
                {header()}
                {connectionEndInfoSheet()}
            </View>
        </SafeAreaView>
    )

    function connectionEndInfoSheet() {
        return (
            <BottomSheet
                isOpen={false}
                sliderMinHeight={400}
    ...
    function directionInfo() {
        ...
        return (
            ...
            >
                <Marker
                    coordinate={currentlanguageLocation}
                    title="Island Pkwy"
                >
                    <Image
...
export default connectionEndScreen
