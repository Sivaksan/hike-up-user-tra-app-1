...
const userconnectionsList = [
    {
        id: '1',
        translatorImage: require('../../assets/images/users/user3.png'),
        translatorName: 'Cameron Williamson',
        languageName: 'Hyundari Wagonr',
    ...
    {
        id: '2',
        translatorImage: require('../../assets/images/users/user4.png'),
        translatorName: 'Jenny Wilson',
        languageName: 'Hyundari Wagonr',
    ...
    {
        id: '3',
        translatorImage: require('../../assets/images/users/user5.png'),
        translatorName: 'Esther Howard',
        languageName: 'Hyundari Wagonr',
...
const UserconnectionsScreen = ({ navigation }) => {
    return (
    ...
    function userconnections() {
        const renderItem = ({ item }) => (
            <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => { navigation.push('connectionDetail') }}
                style={styles.connectionsInfoWrapStyle}
            >
                <View style={{ marginBottom: Sizes.fixPadding * 2.0, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <Image
                            source={item.translatorImage}
